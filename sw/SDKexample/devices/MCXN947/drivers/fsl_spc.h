...
/*! @name Driver version */
/*@{*/
/*! @brief SPC driver version 2.0.0. */
#define FSL_SPC_DRIVER_VERSION (MAKE_VERSION(2, 0, 0))
/*@}*/
...
enum _spc_analog_module_control
{
    ...
    kSPC_controlDac1       = 1UL << 5UL,  /*!< Enablle/disable DAC1 in active or low-power modes.  */
    ...
    kSPC_controlOpamp1     = 1UL << 9UL,  /*!< Enable/disable OPAMP1 in actove or low-power modes. */
    kSPC_controlOpmap2     = 1UL << 10UL, /*!< Enable/disable OPAMP2 in active or low-power modes. */
                                                      ...
                                                      spc_vdd_core_glitch_ripple_counter_select_t rippleCounter)
{
    return ((base->VDD_CORE_GLITCH_DETECT_SC & SPC_VDD_CORE_GLITCH_DETECT_SC_GLITCH_DETECT_FLAG_MASK) ==
            SPC_VDD_CORE_GLITCH_DETECT_SC_GLITCH_DETECT_FLAG(1U << (uint8_t)(rippleCounter)));
}
...
static inline void SPC_ClearGlitchRippleCounterOutput(SPC_Type *base,
                                                      spc_vdd_core_glitch_ripple_counter_select_t rippleCounter)
{
    base->VDD_CORE_GLITCH_DETECT_SC |= SPC_VDD_CORE_GLITCH_DETECT_SC_GLITCH_DETECT_FLAG(1U << (uint8_t)(rippleCounter));
}
