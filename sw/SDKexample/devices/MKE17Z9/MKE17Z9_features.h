...
#ifndef _MKE17Z9_FEATURES_H_
#define _MKE17Z9_FEATURES_H_
...
#define FSL_FEATURE_SOC_ADC12_COUNT (1)
...
#define FSL_FEATURE_SOC_TSI_COUNT (2)
...
/* @brief Total number of DMA channels on all modules. */
#define FSL_FEATURE_DMAMUX_DMAMUX_CHANNELS (8)
...
#define FSL_FEATURE_SCG_HAS_NO_SOSCCFG (0)
...
/* @brief Has channel used for mutual cap TX configuration (register bit MUL0[M_TX_USED]). */
...
#define FSL_FEATURE_TSI_HAS_SHIELD_REGISTER (1)
