...
struct nt_module_data
{
    ...
    uint8_t *electrodes_rand_order_arr;    /*!< Array with order of measured electrodes */
...
/**
 * \brief Process module cross-talk tests
 * \param module Pointer to the module under test.
 * \return The result of the operation.
 */
int32_t _nt_module_process_xtalk(struct nt_module_data *module);
...
uint32_t _nt_module_count_xtalk_electrodes(const struct nt_module *module);
