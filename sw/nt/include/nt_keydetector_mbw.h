 ...
 */
#ifndef NT_KEYDETECTOR_MBW_H
#define NT_KEYDETECTOR_MBW_H

 /**
 * \defgroup mbw mbw Detector
 * \ingroup detectors
 *
 * The mbw key detector is a method for recognizing the touch or release states. It can be used for each type of control.
 *
...
/**
 * The default mbw settings of the key detector are:
 ...
 * Here is an example definition of the default values for mbw ASC:
  \code
const struct nt_keydetector_mbw nt_keydetector_mbw_default = {
  ...
  \endcode
 */
extern const struct nt_keydetector_mbw nt_keydetector_mbw_default;

/**
 * The main structure representing the mbw key detector.
 * An instance of this data type represents the mbw key detector. It consists of the used filters' parameters.
 *
 * You're responsible for the initialization of all members before registering the mbw in
...
/**
 * mbw key detector interface structure.
 */
extern const struct nt_keydetector_interface nt_keydetector_mbw_interface;
