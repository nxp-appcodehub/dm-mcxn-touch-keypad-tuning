 ...
 */
typedef enum _nt_control_adjacent_mode
{
    kAdj_disable   = 0U, /*!< Didable grounding and shileding. */
    kAdj_grounding = 1U, /*!< Enables grounding of control's unmeasured electrodes channels (improves xtalk). */
#if defined(FSL_FEATURE_TSI_HAS_SHIELD_REGISTER) && FSL_FEATURE_TSI_HAS_SHIELD_REGISTER 
    kAdj_shielding = 2U, /*!< Enable shielding of control's unmeasured electrodes channels. */
#endif /* FSL_FEATURE_TSI_HAS_SHIELD_REGISTER */
} nt_control_adjacent_mode;
...
struct nt_control
{
    ...
    const nt_control_adjacent_mode adjacent_electrodes; /*!< Enables grounding of control's unmeasured electrodes channels (improves xtalk). */
};
