...
#define BOARD_TSI_MUTUAL_ELECTRODE_1  NT_TSI_TRANSFORM_MUTUAL(BOARD_TSI_MUTUAL_RX_ELECTRODE_1, BOARD_TSI_MUTUAL_TX_ELECTRODE_1)
#define BOARD_TSI_MUTUAL_ELECTRODE_2  NT_TSI_TRANSFORM_MUTUAL(BOARD_TSI_MUTUAL_RX_ELECTRODE_1, BOARD_TSI_MUTUAL_TX_ELECTRODE_2)
#define BOARD_TSI_MUTUAL_ELECTRODE_3  NT_TSI_TRANSFORM_MUTUAL(BOARD_TSI_MUTUAL_RX_ELECTRODE_1, BOARD_TSI_MUTUAL_TX_ELECTRODE_3)
#define BOARD_TSI_MUTUAL_ELECTRODE_4  NT_TSI_TRANSFORM_MUTUAL(BOARD_TSI_MUTUAL_RX_ELECTRODE_2, BOARD_TSI_MUTUAL_TX_ELECTRODE_1)
#define BOARD_TSI_MUTUAL_ELECTRODE_5  NT_TSI_TRANSFORM_MUTUAL(BOARD_TSI_MUTUAL_RX_ELECTRODE_2, BOARD_TSI_MUTUAL_TX_ELECTRODE_2)
#define BOARD_TSI_MUTUAL_ELECTRODE_6  NT_TSI_TRANSFORM_MUTUAL(BOARD_TSI_MUTUAL_RX_ELECTRODE_2, BOARD_TSI_MUTUAL_TX_ELECTRODE_3)
#define BOARD_TSI_MUTUAL_ELECTRODE_7  NT_TSI_TRANSFORM_MUTUAL(BOARD_TSI_MUTUAL_RX_ELECTRODE_3, BOARD_TSI_MUTUAL_TX_ELECTRODE_1)
#define BOARD_TSI_MUTUAL_ELECTRODE_8  NT_TSI_TRANSFORM_MUTUAL(BOARD_TSI_MUTUAL_RX_ELECTRODE_3, BOARD_TSI_MUTUAL_TX_ELECTRODE_2)
#define BOARD_TSI_MUTUAL_ELECTRODE_9  NT_TSI_TRANSFORM_MUTUAL(BOARD_TSI_MUTUAL_RX_ELECTRODE_3, BOARD_TSI_MUTUAL_TX_ELECTRODE_3)

/* Mutual Tx/Rx channel assignment */
#define BOARD_TSI_MUTUAL_TX_ELECTRODE_1  TF_TSI_MUTUAL_CAP_TX_CHANNEL_1  /*  */
#define BOARD_TSI_MUTUAL_TX_ELECTRODE_2  TF_TSI_MUTUAL_CAP_TX_CHANNEL_2  /*  */
#define BOARD_TSI_MUTUAL_TX_ELECTRODE_3  TF_TSI_MUTUAL_CAP_TX_CHANNEL_3  /*  */

#define BOARD_TSI_MUTUAL_RX_ELECTRODE_1  TF_TSI_MUTUAL_CAP_RX_CHANNEL_14 /*  */
#define BOARD_TSI_MUTUAL_RX_ELECTRODE_2  TF_TSI_MUTUAL_CAP_RX_CHANNEL_15 /*  */
#define BOARD_TSI_MUTUAL_RX_ELECTRODE_3  TF_TSI_MUTUAL_CAP_RX_CHANNEL_16 /*  */


/* Self cap electrodes */
//#define BOARD_TSI_SELF_ELECTRODE_1  TF_TSI_SELF_CAP_CHANNEL_21         /* PTE5  J4 9 */
//#define BOARD_TSI_SELF_ELECTRODE_2  TF_TSI_SELF_CAP_CHANNEL_19         /* PTE13 J4 11 */

#define BOARD_TSI_SPRING_ELECTRODE_1  TF_TSI_SELF_CAP_CHANNEL_8         
#define BOARD_TSI_SPRING_ELECTRODE_2  TF_TSI_SELF_CAP_CHANNEL_9         

// According to the schematic
//#define BOARD_TSI_SELF_ELECTRODE_1    TF_TSI_SELF_CAP_CHANNEL_10
//#define BOARD_TSI_SELF_ELECTRODE_2    TF_TSI_SELF_CAP_CHANNEL_11
//#define BOARD_TSI_SELF_ELECTRODE_3    TF_TSI_SELF_CAP_CHANNEL_13
//#define BOARD_TSI_SELF_ELECTRODE_4    TF_TSI_SELF_CAP_CHANNEL_4
//#define BOARD_TSI_SELF_ELECTRODE_5    TF_TSI_SELF_CAP_CHANNEL_5
//#define BOARD_TSI_SELF_ELECTRODE_6    TF_TSI_SELF_CAP_CHANNEL_7
//#define BOARD_TSI_SELF_ELECTRODE_7    TF_TSI_SELF_CAP_CHANNEL_17
//#define BOARD_TSI_SELF_ELECTRODE_8    TF_TSI_SELF_CAP_CHANNEL_19
//#define BOARD_TSI_SELF_ELECTRODE_9    TF_TSI_SELF_CAP_CHANNEL_20
//#define BOARD_TSI_SELF_ELECTRODE_10   TF_TSI_SELF_CAP_CHANNEL_21
//#define BOARD_TSI_SELF_ELECTRODE_11   TF_TSI_SELF_CAP_CHANNEL_22
//#define BOARD_TSI_SELF_ELECTRODE_12   TF_TSI_SELF_CAP_CHANNEL_23
//#define BOARD_TSI_SELF_ELECTRODE_LOOP TF_TSI_SELF_CAP_CHANNEL_24

// According to the real Keypad marking
#define BOARD_TSI_SELF_ELECTRODE_12    TF_TSI_SELF_CAP_CHANNEL_10
#define BOARD_TSI_SELF_ELECTRODE_11    TF_TSI_SELF_CAP_CHANNEL_11
#define BOARD_TSI_SELF_ELECTRODE_10    TF_TSI_SELF_CAP_CHANNEL_13
#define BOARD_TSI_SELF_ELECTRODE_9     TF_TSI_SELF_CAP_CHANNEL_4
#define BOARD_TSI_SELF_ELECTRODE_8     TF_TSI_SELF_CAP_CHANNEL_5
#define BOARD_TSI_SELF_ELECTRODE_7     TF_TSI_SELF_CAP_CHANNEL_7
#define BOARD_TSI_SELF_ELECTRODE_6     TF_TSI_SELF_CAP_CHANNEL_17
#define BOARD_TSI_SELF_ELECTRODE_5     TF_TSI_SELF_CAP_CHANNEL_19
#define BOARD_TSI_SELF_ELECTRODE_4     TF_TSI_SELF_CAP_CHANNEL_20
#define BOARD_TSI_SELF_ELECTRODE_3     TF_TSI_SELF_CAP_CHANNEL_21
#define BOARD_TSI_SELF_ELECTRODE_2     TF_TSI_SELF_CAP_CHANNEL_22
#define BOARD_TSI_SELF_ELECTRODE_1     TF_TSI_SELF_CAP_CHANNEL_23
#define BOARD_TSI_SELF_ELECTRODE_LOOP  TF_TSI_SELF_CAP_CHANNEL_24
...
#endif
/*
#define BOARD_LED1_GPIO GPIO0
#define BOARD_LED1_GPIO_PIN 2U

#define BOARD_LED2_GPIO GPIO0
#define BOARD_LED2_GPIO_PIN 3U

#define BOARD_LED3_GPIO GPIO0
#define BOARD_LED3_GPIO_PIN 22U

#define BOARD_LED4_GPIO GPIO0
#define BOARD_LED4_GPIO_PIN 23U

#define BOARD_LED5_GPIO GPIO2
#define BOARD_LED5_GPIO_PIN 0U

#define BOARD_LED6_GPIO GPIO2
#define BOARD_LED6_GPIO_PIN 1U

#define BOARD_LED7_GPIO GPIO4
#define BOARD_LED7_GPIO_PIN 2U

#define BOARD_LED8_GPIO GPIO4
#define BOARD_LED8_GPIO_PIN 3U

#define BOARD_LED9_GPIO GPIO2
#define BOARD_LED9_GPIO_PIN 6U

#define BOARD_LED10_GPIO GPIO2
#define BOARD_LED10_GPIO_PIN 7U

#define BOARD_LED11_GPIO GPIO4
#define BOARD_LED11_GPIO_PIN 5U

#define BOARD_LED12_GPIO GPIO4
#define BOARD_LED12_GPIO_PIN 4U
*/
